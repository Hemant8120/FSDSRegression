...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            # Imported from notebooks\Model Training.ipynb Cell-7
            categorical_cols = ['cut', 'color', 'clarity']
            numerical_cols = ['carat', 'depth', 'table', 'x', 'y', 'z']

            # Define the custom ranking for each ordinal variable
            # Imported from notebooks\Model Training.ipynb Cell-8
            ...
            # Numerical Pipeline
            # Imported from notebooks\Model Training.ipynb Cell-11
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            preprocessing_obj = self.get_data_transformation_object()  # Imported from Line-26
